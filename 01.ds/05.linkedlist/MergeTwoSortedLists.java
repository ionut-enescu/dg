 ...
 * 
 * Return a new sorted list created by merging together the nodes of the first
 * two lists.
 * 
 * Examples
 * Example 1:
 ...
 * Expected Output:
 * [1, 2, 3, 4, 5, 6]
 * Justification: As the first list contains all smaller elements, combining
 * them results in a new list with elements from the first list followed by the
 * second one.
 * Constraints:
 * 
...
public class MergeTwoSortedLists {
    ...
    public static void main(String[] args) {
        ...
        ListNode l1 = mergeTwoSortedLists.new ListNode(1,
                mergeTwoSortedLists.new ListNode(3, mergeTwoSortedLists.new ListNode(5)));
        ListNode l2 = mergeTwoSortedLists.new ListNode(2,
                mergeTwoSortedLists.new ListNode(4, mergeTwoSortedLists.new ListNode(6)));
...
// lists
// space complexity: O(1), since we are not using any extra space apart from the
// input lists and the merged list