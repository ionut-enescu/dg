 ...
 * 
 * A doubly linked list is a palindrome if it reads the same backward as
 * forward, utilizing the previous and next pointers of the nodes.
 * 
 * Examples
 * Example 1:
 * 
 ...
 * Input: 1 <-> 2 <-> 2 <-> 3
 * Output: false
 * Justification: Reading backward, the list is 3 <-> 2 <-> 2 <-> 1, which is
 * not the same as reading forward.
 * Example 3:
 * 
 * Input: 1 <-> 1 <-> 1 <-> 1
 * Output: true
