 ...
 * k = 4
 * Expected Output: 6
 * Justification: The in-order traversal of the tree is [1, 3, 4, 6, 7, 8, 10,
 * 13, 14]. The 4th element in this sequence is 6.
 * 
 * Example 2:
 * Input:
 * 
 ...
 * k = 3
 * Expected Output: 5
 * Justification: The in-order traversal of the tree is [1, 2, 5, 6]. The 3rd
 * element in this sequence is 5.
 * 
 * Example 3:
 * Input:
 * 
 ...
 * k = 2
 * Expected Output: 2
 * Justification: The in-order traversal of the tree is [1, 2, 3]. The 2nd
 * element in this sequence is 2.
 * 
 * Constraints:
 * 
...
// worst case, we may need to traverse all nodes to find the kth smallest
// element.
// Space Complexity: O(n), where n is the number of nodes in the tree. We are
// storing the values of all nodes in a list.
