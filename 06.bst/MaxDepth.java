/**
 * Given a root node of the binary tree, return the depth (or height) of a
 * binary tree.
 * 
 * The Depth of the binary tree refers to the number of nodes along the longest
 * path from the root node to the farthest leaf node. If the tree is empty, the
 * depth is 0.
 * 
 * Examples
 * Example 1
...
// Space Complexity: O(h), where h is the height of the binary tree. This is due
// to the recursion stack space used during the traversal.
