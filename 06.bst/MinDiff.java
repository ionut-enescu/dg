...
// traverse each node once to build the list and then again to find the minimum
// difference.
// Space Complexity: O(n), where n is the number of nodes in the tree. We store
// all node values in a list.
